...
final class AppDetailViewController: UIViewController {
    ...
    private let shareButton: UIButton = {
        ...
        button.addTarget(nil, action: #selector(didTapShareButton), for: .touchUpInside)
        return button
    }()
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = .systemBackground // for dark mode since iOS 13
